...
def build_parser(subparsers: Any) -> None:
    ...
    parser.add_argument("--skip-diy", action="store_true", help="Skip executing DIY patch scripts")
...
def handle_run_all(args: argparse.Namespace) -> int:
    ...
    # Step 2: Feeds & DIY Patches
    print("\n>>> [2/6] Setting up package feeds & applying DIY patches...", flush=True)
